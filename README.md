...
* Date now是一个新方法，不过不是所有的系统版本都支持,建议谨慎使用，可以使用getTime来替代

**DOM选择器**

html5为了我们提供了一个非常好的DOM选择器，就是document.querySelector和document.querySelectorAll这两个方法，这两个方法在android2.1+以及ios3+以后，都可以使用，其接受的参数为css选择器
